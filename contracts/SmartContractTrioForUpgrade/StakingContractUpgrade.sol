...
import {RewardTokenUpgrade} from "./RewardTokenUpgrade.sol";

import {IERC721Receiver} from "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";

import {NFT721Upgrade} from "./NFT721Upgrade.sol";
 ...
 * @author Tony
 * @notice
 * @dev User can stake an NFT under the NFT721Upgrade contract and get the corrospending RewardToken, which based on the staking period.
